...
import { User, Mail, Phone, Calendar, GraduationCap, Camera, Save, X, Lock, Bell, Trash2, BookOpen, Award, CheckCircle2, XCircle, AlertCircle } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export default function StudentProfile() {
  const [formData, setFormData] = useState({
    prenom: "Fatma",
    nom: "Hamdi",
    email: "fatma.hamdi@student.edunex.com",
    role: "etudiant",
    image_User: null,
    NumTel: "+216 25 789 123",
    Adresse: "Sousse, Tunisie",
    datedeNaissance: "2003-08-20",
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium">Sep 2023</span>
              </div>
            </CardContent>
          </Card>
